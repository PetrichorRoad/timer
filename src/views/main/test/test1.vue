<template>
  <div
    class="bg-my-bg-1 h-full flex flex-col gap-4 box-border p-4 w-full border-box"
  >
    <div class="flex gap-4 flex-1">
      <div class="flex-1 flex flex-col gap-4">
        ...
        <div class="flex-1 flex flex-col gap-4">
          <div class="flex gap-4 flex-1">
            <div
              class="w-[60%] bg-my-bg-4 rounded-md flex flex-col justify-between p-4 text-my-text-3"
            >
              ...
              <div class="flex gap-2">
                <span class="p-1 rounded-md"
                  >温度 ： {{ weather?.humidity }}</span
                >
                <span class="p-1 rounded-md"
                  >风力 ： {{ weather?.windpower }}</span
                >
                <span class="p-1 rounded-md"
                  >风向 ： {{ weather?.winddirection }}</span
                >
              </div>
            </div>
          ...
          <div
            class="bg-my-bg-4 h-[200px] rounded-md flex justify-around gap-2 px-2 items-center"
          >
            <div
            ...
            >
              <div
                class="bg-my-bg-3 rounded-full w-[80px] h-[30px] flex items-center justify-center text-my-text-3"
                v-text="weekMap[item.week]"
              ></div>
              <div class="text-my-text-2 text-xs" v-text="item.date"></div>
              <div
                class="text-my-text-2 text-xs"
                v-text="item.dayweather"
              ></div>
      ...
      <div class="flex-1 flex flex-col gap-4">
        ...
        <div
          class="h-[100px] bg-my-bg-2 rounded-md flex items-center justify-between"
        >
          <div class="flex items-center justify-between px-4 gap-4">
            ...
            <div
              class="w-[50px] h-[50px] bg-my-bg-1 flex items-center justify-center rounded-full"
            >
    ...
    <div
      class="h-[200px] bg-my-bg-2 rounded-md px-8 border-box justify-between flex gap-8"
    >
      <div class="flex flex-col justify-center gap-4 ml-8 w-[20%]">
        <span class="text-my-text-1 text-2xl">Investments</span>
      ...
      <div class="flex items-center gap-4 justify-center">
        ...
        <div
          class="h-[150px] rounded-md bg-my-bg-3 w-[100px] flex flex-col pl-4 justify-center gap-4 border-box"
        >
          <div class="text-my-text-3 text-lg">view all</div>
          <div
            class="w-[30px] h-[30px] bg-my-bg-1 flex items-center justify-center rounded-full"
          >
