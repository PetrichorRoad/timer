<template>
  <div class="icon sun-shower" v-show="weather === 0">
    <div class="cloud"></div>
    <div class="sun">
      <div class="rays"></div>
    </div>
  ...
  <div class="icon thunder-storm" v-show="weather === 1">
    <div class="cloud"></div>
    <div class="lightning">
      <div class="bolt"></div>
      <div class="bolt"></div>
  ...
  <div class="icon cloudy" v-show="weather === 2">
    <div class="cloud"></div>
    <div class="cloud"></div>
  </div>

  <div class="icon flurries" v-show="weather === 3">
    <div class="cloud"></div>
    <div class="snow">
      <div class="flake"></div>
      <div class="flake"></div>
  ...
  <div class="icon sunny" v-show="weather === 4">
    <div class="sun">
      <div class="rays"></div>
    </div>
  </div>

  <div class="icon rainy" v-show="weather === 5">
    <div class="cloud"></div>
    <div class="rain"></div>
  </div>
</template>
