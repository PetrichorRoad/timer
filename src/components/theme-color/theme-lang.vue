<template>
    <div class="pr-2">
        <n-radio-group :value="computedLocale" @update:value="changeLanguage" size="small">
            <n-radio-button v-for="song in songs" :key="song.value" :value="song.lang" :label="song.label" />
        </n-radio-group>
    </div>
</template>
